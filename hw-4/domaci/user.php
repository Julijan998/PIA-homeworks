...
<body style="background-color: #000; color: white;">
  ...
  <a class="navbar-brand justifu-content-center text-center" style="margin-right: 14%;" href="index.php">
...
for($i = 0; $i < mysqli_num_rows($res); $i++)
 ...
 echo "<h1 class='text-center text-danger mb-3 mt-4 ml-5 mr-5 border-bottom border-bottom-1 border-warning'>Korisnicki nalog</h1>";
