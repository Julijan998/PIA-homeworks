...
<body style="background-color: #000; color: white;">
  ...
  <nav class="navbar fixed-top navbar-expand-lg  navbar-light border-bottom border-bottom-1 border-warning bg-dark">
    <div class="container-fluid ">
     <a class="navbar-brand" style="margin-right: 5%;" href="index.php">
    ...
    <li class="nav-item ">
           <a class='nav-link active' style='color: white' href="index.php">Početak</a>
           </li>
          <li class="nav-item ">
            <?php echo "<a class='nav-link text-white active' href='all-movies.php'>Svi filmovi</a>"; ?>
          </li> 
          <li class="nav-item justify-content-end">
           <a class='nav-link active' style='color: white' href="category.php">Kategorije</a>
           </li>
