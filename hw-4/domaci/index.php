 ...
 ?>
  ...
  <div class="dropdown-menu bg-dark" aria-labelledby="dropdownMenuButton">
    ...
    <p class="dropdown-item" ><?php  if (isset($_SESSION['username'])) : ?>
      <p class="nav-link text-center"><a style="text-decoration: none;" href="user.php"><img style="height: 30px;" src="static/images/user-img.png"><strong class="text-warning"> <?php echo "$name"; ?></strong> </a>
      <?php endif ?>
    </p><p>
    <a href="index.php?logout='1'" class="nav-link bg-danger rounded text-white text-center" style="text-decoration: none;">Odjavite se</a> </p> 
      ...
      <li class="nav-item">
        <a class="nav-link" href="all-movies.php">Filmovi</a>
      </li>
    </ul>

  <a class="navbar-brand justify-content-center" style="margin-right: 12%;" href="index.php ">
...
<div>
 ...
 <div style="margin-left: 5%; margin-right: 5%;" class="d-flex flex-wrap justify-content-center">
  ...
  <a style="text-decoration: none;" href="http://localhost/domaci/movies.php?id=1"><img class="mb-2" src="static/movies/image1.jpg" style="height: 400px;" alt="Deadpool" style="width:100%"><h1 id="dp" class="text-white">Deadpool</h1></a>
  ...
  <div class="order-2 p-2">
    <div class="card bg-dark">
  <a style="text-decoration: none;" href="http://localhost/domaci/movies.php?id=4"><img class="mb-2" src="static/movies/image4.jpg" style="height: 400px;" alt="Inception" style="width:100%"> <h1 id="dp" class="text-white">Inception</h1> </a>
  ...
  <div class="order-1 p-2">
    <div class="card bg-dark">
 <a style="text-decoration: none;" href="http://localhost/domaci/movies.php?id=17"> <img class="mb-2" src="static/movies/image17.jpg" style="height: 400px;" alt="Hangover" style="width:100%"><h1 id="dp" class="text-white">The Hangover</h1></a>
  ...
  <div class="order-1 p-2">
    <div class="card bg-dark">
 <a style="text-decoration: none;" href="http://localhost/domaci/movies.php?id=2"> <img class="mb-2" src="static/movies/image2.jpg" style="height: 400px;" alt="Joker" style="width:100%"><h1 id="dp" class="text-white">Joker</h1></a>
