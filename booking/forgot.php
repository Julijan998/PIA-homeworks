...
if(!empty($_POST)){
 ...
 echo "<script>alert('Vasa sifra je: $Row[3]'); window.location='http://localhost/d1/login.php';</script>";
 $username_find = true;
 break;
}
 }
 if($username_find == false){
 echo "<script>alert('Korisnicko ime koje ste uneli nije registrovano. Pokusajte ponovo'); window.location='http://localhost/d1/forgot.php';</script>";
 }
 }
 fclose($file_handle);
 }
...
<style type="text/css">
 body{
    margin: 0;
    padding: 0;
    background: url(static/images/180412122543-best-places-to-visit-in-serbia---tara-by-sasa-preradovic-super-tease.jpg);
